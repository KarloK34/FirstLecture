...
class _DataService implements DataService {
  _DataService(
    ...
    baseUrl ??= 'https://cope-hive-wtsg6fob5q-ew.a.run.app/hive';
  }
  ...
  Future<LeaveRequest> getRequest(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LeaveRequest>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<LeaveRequest>> getRequests({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<LeaveRequest>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    try {
      _value = _result.data!
          .map((dynamic i) => LeaveRequest.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
